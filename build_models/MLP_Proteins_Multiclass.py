...
mlp_b=MLPClassifier(max_iter = 1000, hidden_layer_sizes=(50,), solver='adam', alpha=0.075, learning_rate='invscaling', momentum = 0.9)
...
mlp_fi=MLPClassifier(max_iter = 1000, hidden_layer_sizes=(50,), solver='adam', alpha=0.075, learning_rate='invscaling', momentum = 0.9)
...
df_importance.to_csv('FI_MLPBestBinaryMB6')
