...
# SVM Linear kernel
from sklearn.svm import SVC
svm_L=SVC(C = 5, decision_function_shape = 'ovr', kernel = 'linear')
...
# SVM
from sklearn.svm import SVC
#svm_b=SVC(C = 1, decision_function_shape = 'ovo', kernel = 'poly', gamma = 'scale', degree = 4)
svm_b=SVC(C = 1, decision_function_shape = 'ovo', kernel = 'linear')
...
svm_r=SVC(C = 1, decision_function_shape = 'ovo', kernel = 'poly', gamma = 'scale', degree = 4, probability=True)
